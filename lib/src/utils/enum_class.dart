...
class EnumClass<K, V> {
  ...
  /// This method allows you to use the `getKeyForValue` method
  /// to get the key for a value.
  ...
  /// This method allows you to use the `getValueForKey` method
  ...
  /// This method allows you to use the `keys` property
  /// to get the keys of the enum.
  Iterable<K> get keys => _map.keys;

  /// Returns the values of the enum.
  /// This method allows you to use the `values` property
  /// to get the values of the enum.
  ...
  /// This method allows you to use the `map` property
  /// to get the map of the enum.
  Map<K, V> get map => _map;

  /// Returns the value for a key.
  /// This method allows you to use the `[]` operator
  /// to get the value for a key.
